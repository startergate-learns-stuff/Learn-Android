...
public class GridViewEx extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyGridAdapter mg = new MyGridAdapter(this);
        gv.setAdapter(mg);
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            iv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    View dialogView = View.inflate(GridViewEx.this, R.layout.movie_dialog, null);

                    AlertDialog.Builder dlg = new AlertDialog.Builder(GridViewEx.this);
                    ImageView bigPoster = dialogView.findViewById(R.id.bigPoster);
